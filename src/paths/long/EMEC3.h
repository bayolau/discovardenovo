 ...
 *
 */
void run_EMEC3( const _BaseVecVec& call, const _QualVecVec& callq, _BaseVec& t, _QualVec& q, vector<double>& pfriend, int& trim_to, const unsigned debug_level = 0, const size_t serialno = 0 );
