...
class readstack {
     ...
     void CorrectAllEM3( basevector& b, qualvector& q, int& trim_to, vector<double>& pfriend, bool debug = false) const;
     ...
     void Print( ostream& out, const int w = 70 ) const;
     void Print( ostream& out, const vec<basevector>& cons, const int w = 70 ) const;
     void Print( ostream& out, const vec<vec<char>>& con, const int w = 70 ) const;
