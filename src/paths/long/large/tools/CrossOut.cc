...
int main(int argc, char *argv[])
{
     ...
     {    cout << Date( ) << ": making kmers, pass " << pass+1 << endl;
          ...
          {    int64_t& s = bstart[i];
               ...
               {    s--;    }    }
          cout << Date( ) << ": traversing kmers" << endl;
     ...
     {    int64_t j;
          ...
          {    dels[id].push_back(e);
               ...
               {    int64_t l;
                    ...
                    if ( k > i ) cout << ",";
                    cout << tags[k].third;
                    if ( l-1 > k ) cout << "-" << tags[l-1].third;
                    k = l - 1;    }
               cout << " (" << PERCENT_RATIO( 3, hits, total ) << ")\n";    }
          i = j - 1;    }
     cout << "\n" << Date( ) << ": tagging complete" << endl;

     // Delete edges and write final files.

     cout << Date( ) << ": deleting edges and writing files" << endl;
     for ( int j = 0; j < nsam; j++ )
