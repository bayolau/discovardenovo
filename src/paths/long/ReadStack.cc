...
void readstack::Print( ostream& out, const vec<vec<char>>& con, const int w ) const
{
...
void readstack::Print( ostream& out, const vec<basevector>& cons, const int w ) const
...
void readstack::Print( ostream& out, const int w ) const
{    int n = Rows( ), k = Cols( );
     basevector con;
     qualvector conq;
     Consensus1( con, conq );
...
void readstack::CorrectAllEM3( basevector& b, qualvector& q, int& trim_to, vector<double>& pfriend, bool debug ) const
{
    StackBaseVec b_tmp;
    StackQualVec q_tmp;
