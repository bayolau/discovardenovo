...
///
/// OUTPUT=output-file sends all output to the given file; otherwise cout is used.
///
...
int main( int argc, char *argv[] )
{
     ...
     {    ForceAssert( QUAL2 == "" );
          ...
          QUAL2 = QUAL1;
          LT = True;
          if ( !SILENT ) cout << "doing self-comparison\n\n";    }
     ...
     if ( !SILENT ) cout << "running " << passes << " passes" << endl;
